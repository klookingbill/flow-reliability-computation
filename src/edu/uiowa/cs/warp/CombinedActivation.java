...
/*package*/ CombinedActivation (String name) {
super(name);
   	}

/*package*/ CombinedActivation (Activation elem, Integer time) {
super(elem, time);	
   	}

/*package*/ CombinedActivation (Activation priorEntry, Activation next) {
