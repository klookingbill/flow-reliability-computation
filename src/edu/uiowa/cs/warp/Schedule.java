 ...
 * 	 * 
 * 	 * @return duration-vacantSlots */protected Integer timeRemaining(Integer channel, Integer start, Integer duration) {
var result = duration;
...
/*package*/ Schedule (Poset poset, Integer numChannels) {
this.poset = poset;
 ...
 * 	 * 
 * 	 * @param program */private void replaceNullWithSleep(ProgramSchedule program) {
 ...
 * 	 * 
 * 	 * @return available channel or numChannels when none available */protected Integer getChannelAndSetStartTime(Activation schedulableObject) {
 ...
 * 	 * @param time
 * 	 * @param activation
 * 	 * @return ScheduleLocation */protected ScheduleLocation continueSearch(Integer time, Activation activation) {
 ...
 * 	 * interval [start, start+duration-1] */protected Boolean isAvailable(Activation a1, Integer channel, Integer start, Integer duration) {
var available = true;
 ...
 * 	 * interval [start, start+duration-1] in any channel */protected Boolean isAvailable(Activation a1, Integer start, Integer duration) {
var available = false;
...
/*package*/ Integer channel;
/*package*/ Integer time;
/*package*/ ScheduleLocation () {
this.channel = 0;
   			this.time = 0;
   		}

/*package*/ ScheduleLocation (Integer channel, Integer time) {
this.channel = channel;
   			this.time = time;
   		}

/**
* @return the channel */protected Integer getChannel() {
return channel;
   		}

/**
* @return the time */protected Integer getTime() {
return time;
   		}
