...
* @author sgoddard
 * @version 1.5
 *  * *//*package*/ abstract class VisualizationObject {
...
/**
* @return the fm */public FileManager getFileManager() {
return fm;
     }
...
/*package*/ VisualizationObject (FileManager fm, WorkLoad workLoad, String suffix) {
this.fm = fm;
...
/*package*/ VisualizationObject (FileManager fm, SystemAttributes warp, String suffix) {
this.fm = fm;
...
/*package*/ VisualizationObject (FileManager fm, SystemAttributes warp, String nameExtension, String suffix) {
this.fm = fm;
    if (warp.getNumFaults() > 0) {
      this.nameExtension =
...
/*package*/ VisualizationObject (FileManager fm, String nameExtension, String suffix) {
this.fm = fm;
