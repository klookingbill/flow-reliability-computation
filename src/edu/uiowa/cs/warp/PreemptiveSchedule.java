...
/*package*/ PreemptiveSchedule (Poset poset, Integer numChannels) {
...
private ArrayList <ScheduleTime> findAdditionalTime(Integer channel, Integer startTime, Activation a1, Integer timeRemaining) {
var time = startTime;
...
private Boolean addToSchedule(Activation next, Integer channel, Integer startTime, Integer endTime) {
var success = true;
