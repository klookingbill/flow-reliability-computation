...
/*package*/ String gvFileContents;
/*package*/ String gvTitleCaption;
/*package*/ FileManager wfm;
/*package*/ String graphFile;
 ...
 *      * but will return the current state of the contents string anytime it is called */public String getGraphVizContent() {
...
/*package*/ GraphViz (FileManager wfm, String graphFile) {
...
/*package*/ GraphViz (FileManager wfm, String graphFile, Boolean verbose) {
super(wfm, EMPTY, GRAPH_VIZ_SUFFIX); // VisualizationObject constructor
        this.wfm = wfm; // used to access the basic WARP file management functions
        this.graphFile = graphFile;
        this.gv = this;
