...
/*package*/ String coordinator;
/*package*/ ArrayList <String> codeFragment;
/*package*/ Integer delta;
/*package*/ Integer channel;
/**
* Constructor generates a SLEEP instruction for the
 * 	 * code fragment. *//*package*/ CodeFragment () {
this.delta = 0;
   		this.channel = 0;
   		this.edges = null;
...
/**
* @return the codeFragment */public ArrayList <String> instructions() {
return codeFragment;
   	}

/**
* @return the size */public Integer size() {
 ...
 * 	 * @param edges
 * 	 * @param coordinators
 * 	 * @param channel *//*package*/ CodeFragment (Integer delta, ArrayList <Edge> edges, ArrayList <String> coordinators, Integer channel) {
this.delta = delta;
