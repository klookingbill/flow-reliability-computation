...
public void setConflicts(Set<String> value) {
...
/*package*/ Activation (String name) {
super();
   		setName(name);
...
/**
* @return the edgesByReleaseTime */public PriorityQueue <Edge> getEdgesByReleaseTime() {
return new 
   		SchedulableObjectQueue<Edge>(new ReleaseTimeComparator<Edge>(),this.edges);
   	}

/**
* @return the edgesByReleaseTime */public PriorityQueue <Edge> getEdgesByLatestReleaseTime() {
return new 
   		SchedulableObjectQueue<Edge>(new LatestReleaseTimeComparator<Edge>(),this.edges);
   	}

/**
* @return the edgesByPeriod */public PriorityQueue <Edge> getEdgesByPeriod() {
return new 
   		SchedulableObjectQueue<Edge>(new PeriodComparator<Edge>(),this.edges);
   	}

/**
* @return the edgesByDeadline */public PriorityQueue <Edge> getEdgesByDeadline() {
return new 
   		SchedulableObjectQueue<Edge>(new DeadlineComparator<Edge>(),this.edges);
   	}

/**
* @return the edgesByPriority */public PriorityQueue <Edge> getEdgesByPriority() {
return new 
 ...
 * 	 * 
 * 	 * @param additionalOffset */public void increaseEdgePhases(Integer additionalOffset) {
 ...
 * 	 * edge priority with the earliest release time.
 * 	 * Thus, it can change dynamically. <br> */public void updatePriorityAndRelease(Integer currentTime) {
 ...
 * 	 * @param next
 * 	 * @param time
 * 	 * @return next schedule time or MAX_VALUEs if not found */public ScheduleTime getNextScheduleTime(Integer time) {
 ...
 * 	 * @param next
 * 	 * @param time
 * 	 * @return next start time or MAX_VALUE if not found */public Integer getMatchingEndTime(Integer time) {
 ...
 * 	 * @param next
 * 	 * @param time
 * 	 * @return next start time or MAX_VALUE if not found */public Integer getNextStartTime(Integer time) {
var moreScheduleTimes = getAdditionalScheduleTimes();
   		Iterator<ScheduleTime> iter = moreScheduleTimes.iterator();
 ...
 * 	 * @param next
 * 	 * @param time
 * 	 * @return next start time or MAX_VALUE if not found */public Integer getNextEndTime(Integer time) {
var moreScheduleTimes = getAdditionalScheduleTimes();
   		Iterator<ScheduleTime> iter = moreScheduleTimes.iterator();
   		var nextEndTime = time;
   		while (iter.hasNext() && nextEndTime <= time  ) {
 ...
 * 	 * reliability is met. */public Integer getDelta() {
...
/*package*/ Activation (Activation elem, Integer time) {
super(elem, time);
   		this.edges = new ArrayList<Edge>();
...
/**
* @param additionalScheduleTimes */public void addScheduleTimes(ArrayList <ScheduleTime> scheduleTime) {
