 ...
 * 
 * @author sgoddard */public abstract class Poset {
...
/*package*/ FlowNodeToActivationMap activationMap;
 ...
 * 	 * 
 * 	 * @param time
 * 	 * @return */public Activation getNextActivation() {
 ...
 * 	 * 
 * 	 * @return baseStation for the workload */protected Node findBaseStation() {
 ...
 * 	 *  	many others... *//*package*/ Poset (WorkLoad workload) {
 ...
 * 	 * 
 * 	 * @param activation */public void addActivation(Activation activation) {
...
* *
 * 	 * @param nodesInFlow
 * 	 * @return the node in the flow with highest local connectivity. */protected Integer findCoordinator(ArrayList <Node> nodesInFlow) {
var size = nodesInFlow.size();
