...
public void setIntForNodeNames(Boolean value) {
   this.intForNodeNames = value;
}

public Boolean getIntForNodeNames() {
   return this.intForNodeNames;
}
...
public void setFlows(FlowMap value) {
   this.flows = value;
}
...
public void setNodes(NodeMap value) {
   this.nodes = value;
}
...
public void setFlowNamesInOriginalOrder(ArrayList <String> value) {
   this.flowNamesInOriginalOrder = value;
}

public ArrayList <String> getFlowNamesInOriginalOrder() {
   return this.flowNamesInOriginalOrder;
}

private ArrayList <String> flowNamesInPriorityOrder = new ArrayList<>();

public void setFlowNamesInPriorityOrder(ArrayList <String> value) {
   this.flowNamesInPriorityOrder = value;
}

public ArrayList <String> getFlowNamesInPriorityOrder() {
   return this.flowNamesInPriorityOrder;
}

/**
* Initialize the default parameters for the WorkLoad object */private void setDefaultParameters() {
...
/**
* @return the e2e */public Double getE2e() {
return e2e;
     }

/**
* @return the intForFlowNames */public Boolean getIntForFlowNames() {
...
/**
* @return the maximum phase of all flows */public Integer getMaxPhase() {
var queue = new SchedulableObjectQueue<Flow>(new MaxPhaseComparator<Flow>(), flows.values());
    return queue.poll().getPhase();
     }

/**
* @return the minimum period of all flows */public Integer getMinPeriod() {
var queue = new SchedulableObjectQueue<Flow>(new PeriodComparator<Flow>(), flows.values());
    return queue.poll().getPeriod();
     }

/**
* @param intForFlowNames the intForFlowNames to set */public void setIntForFlowNames(Boolean intForFlowNames) {
 ...
 *    * @param channel the channel to set */public void setNodeChannel(String name, Integer channel) {
...
/**
* @return the node channel */public Integer getNodeChannel(String name) {
var node = nodes.get(name); // get the node object
 ...
 *  @param flowName */public void addFlow(String flowName) {
...
/**
* @return returns true if all node names are ints */public Boolean isIntForNodeNames() {
return intForNodeNames;
     }

public Boolean isIntForFlowNames() {
// returns true if all flow names are an ints
    return intForFlowNames;
     }
 ...
 * @param flowName
 * @param nodeName */public void addNodeToFlow(String flowName, String nodeName) {
 ...
 * @param flowName
 * @param nodeName
 * @return the node priority */public Integer getFlowPriority(String flowName, String nodeName) {
var priority = 0;
 ...
 *    * @param flowName
 *    * @param priority */public void setFlowPriority(String flowName, Integer priority) {
var flowNode = getFlow(flowName);
 ...
 * 	 * @param flowName
 * 	 * @param period */public void setFlowPeriod(String flowName, Integer period) {
var flowNode = getFlow(flowName);
 ...
 *    * @param flowName
 *    * @param deadline */public void setFlowDeadline(String flowName, Integer deadline) {
var flowNode = getFlow(flowName);
 ...
 *    * @param flowName
 *    * @param phase */public void setFlowPhase(String flowName, Integer phase) {
var flowNode = getFlow(flowName);
 ...
 *    * @param flowName
 *    * @return flowNode Index */public Integer getFlowIndex(String flowName) {
var flowNode = getFlow(flowName);
 ...
 *    * @param flowName
 *    * @return flowNode Priority */public Integer getFlowPriority(String flowName) {
var flowNode = getFlow(flowName);
 ...
 *    * @param flowName
 *    * @return flowNode Period */public Integer getFlowPeriod(String flowName) {
var flowNode = getFlow(flowName);
 ...
 *    * @param flowName
 *    * @return flowDeadline */public Integer getFlowDeadline(String flowName) {
var flowNode = getFlow(flowName);
 ...
 *    * @param flowName
 *    * @return Flow node */public Integer getFlowPhase(String flowName) {
var flowNode = getFlow(flowName);
 ...
 *    * @param flowName
 *    * @return flow node */public Integer getFlowTxAttemptsPerLink(String flowName) {
var flowNode = getFlow(flowName);
    return flowNode.numTxPerLink;
     }

/**
* Sorts the flows in priority order and updates the flow names list accordingly. */public void setFlowsInPriorityOrder() {
...
/**
* Sorts the flows in Deadline-Monotonic (DM) order and updates the flow names list accordingly. */public void setFlowsInDMorder() {
/* create a list of Flow objects from the FlowMap using the stream interface. */
    List<Flow> unsortedFlows = flows.values().stream().collect(Collectors.toList());
 ...
 *    * With names in requested order */public void setFlowsInRMorder() {
// create a list of Flow objects from the FlowMap using the stream interface.
    List<Flow> unsortedFlows = flows.values().stream().collect(Collectors.toList());
    // Now sort by a secondary key, which is priority in this case
    List<Flow> sortedByPriority = unsortedFlows.stream()
 ...
 *    * @return nodeNames */public String[] getNodeNamesOrderedAlphabetically() {
var nodes = getNodes();
 ...
 *    * @return Flow Names in Original Order */public String[] getFlowNames() {
 ...
 *    * @param nodeName
 *    * @return node index */public Integer getNodeIndex(String nodeName) {
var index = 0;
 ...
 *    * @param flowName
 *    * @return Array of node names */public String[] getNodesInFlow(String flowName) {
 ...
 *    * @return the HyperPeriod */public Integer getHyperPeriod() {
 ...
 *    * @param flowName
 *    * @return totalCost */public Integer getTotalTxAttemptsInFlow(String flowName) {
var flow = getFlow(flowName);
 ...
 *    * @param flowName
 *    * @return return an array of the number of transmission needed for each */public Integer[] getNumTxAttemptsPerLink(String flowName) {
var flow = getFlow(flowName);
 ...
 *    * @return maxLength */public Integer maxFlowLength() {
Integer maxLength = 0;
 ...
 *    * @param flow
 *    * @return txArrayList */private ArrayList <Integer> getFixedTxPerLinkAndTotalTxCost(Flow flow) {
 ...
 *    * @param nodeName
 *    * @param edge */public void addEdge(String nodeName, Edge edge) {
 ...
 *    * @param m
 *    * @param e2e
 *    * @param inputFileName *//*package*/ WorkLoad (Double m, Double e2e, String inputFileName) {
super(inputFileName);
 ...
 *    * @param m
 *    * @param e2e
 *    * @param inputFileName *//*package*/ WorkLoad (Integer numFaults, Double m, Double e2e, String inputFileName) {
super(inputFileName);
    setDefaultParameters();
...
/**
* @param minPacketReceptionRate the minPacketReceptionRate to set */public void setMinPacketReceptionRate(Double minPacketReceptionRate) {
this.minPacketReceptionRate = minPacketReceptionRate;
     }

/**
* @param e2e the e2e to set */public void setE2e(Double e2e) {
this.e2e = e2e;
     }
