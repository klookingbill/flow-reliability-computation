 ...
 * @author sgoddard
 * @version 1.5 */public class VisualizationImplementation implements Visualization {
 ...
 *    * @return fileNameTemplate of the input outputDirectory */private String createFileNameTemplate(String outputDirectory) {
 ...
 *    * @param warp
 *    * @param outputDirectory
 *    * @param choice */public VisualizationImplementation (WarpInterface warp, String outputDirectory, SystemChoices choice) {
 ...
 *    * @param choice create visualization of */public VisualizationImplementation (WorkLoad workLoad, String outputDirectory, WorkLoadChoices choice) {
this.fm = new FileManager();
 ...
 *    * @param choice */private void createVisualization(SystemChoices choice) {
 ...
 *    * @param choice */private void createVisualization(WorkLoadChoices choice) {
switch (choice) { // select the requested visualization
